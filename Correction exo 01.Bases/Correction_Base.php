...
print "Aujourd'hui nous sommes le 14 octobre 2024";
...
<?php
/** Exercice 7 : Commentaires et PHP
 * Objectif : ecrire du code php et commenter ce que vous ecrivez
 *
 * 1 . Ecrire du code à l'interieur, exemple echo("<div>
 *    <h1>Bienvenue</h1>
...
<body>
    ...
    <?php echo "<div> <h1> Bienvenue </h1> <h2> sur mon application </h2>" ?>
</body>
...
<?php
/** Exercice 8 : Balises PHP dans HTML
...
$date = strftime("%e %B %Y"); // %e : jour sans les zéro, %B : nom complet du mois, %Y : année
echo $date;
*/

/** Exercice 9 : Affichage dynamique
